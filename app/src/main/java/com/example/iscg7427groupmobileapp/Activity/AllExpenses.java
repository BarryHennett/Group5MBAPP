...
public class AllExpenses extends AppCompatActivity {
        ...
        NavigationBarView.OnItemSelectedListener listener = new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.item_home) {
                    ...
                    Intent intent = new Intent(AllExpenses.this, UserDashboardActivity_1.class);
                    startActivity(intent);
                    return true;
                } else if (item.getItemId() == R.id.item_income) {

                    Intent intent = new Intent(AllExpenses.this, UserIncomeDashboardActivity.class);
                    startActivity(intent);
                    ...
                    Intent intent = new Intent(AllExpenses.this, UserProfileActivity.class);
                    startActivity(intent);
                    return true;
                } else return false;
            }
    ...
    private void init() {
        ...
        nav = findViewById(R.id.all_expense_nav);
    }
    ...
    private List<Map.Entry<String, User.Transaction>> filterTransactions(String selectedItem, HashMap<String, User.Transaction> transactions) {
        ...
        try {
            ...
            Toast.makeText(AllExpenses.this, "Error parsing date", Toast.LENGTH_SHORT).show();
            return filteredList;
        }
