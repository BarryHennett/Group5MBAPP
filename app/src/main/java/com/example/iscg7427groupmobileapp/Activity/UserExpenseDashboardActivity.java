        ...
        bottomNavigation.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.item_home) {
                    ...
                    startActivity(new Intent(UserExpenseDashboardActivity.this, UserDashboardActivity_1.class));
                    return true;
                } else if (itemId == R.id.item_income) {
                    Log.d("BottomNav", "Income selected");
                    startActivity(new Intent(UserExpenseDashboardActivity.this, UserIncomeDashboardActivity.class));
                    return true;
                    ...
                    startActivity(new Intent(UserExpenseDashboardActivity.this, UserProfileActivity.class));
                    return true;
                } else {
